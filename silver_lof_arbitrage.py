...
with st.expander("📚 什么是白银LOF套利？", expanded=True):
    st.markdown("""
    **套利核心**：利用LOF基金**场内交易价格**与**基金净值**之间的价差进行交易[citation:1]。
    - **基金净值**：基金持有的白银期货合约的实际价值，随国际银价波动。
    - **场内价格**：在证券交易所像股票一样买卖的价格，受市场情绪和供求影响[citation:1]。
    - **溢价率**：`(场内价格 - 基金净值) / 基金净值 * 100%`，是衡量套利空间的关键指标。
    **基本操作**：当出现高溢价时，理论上可在场外按净值申购基金，然后在场内以更高价格卖出[citation:9]。
    **请注意**：此操作涉及T+2交割、手续费和市场波动风险，高溢价可能快速回落[citation:1][citation:5]。
    """)
